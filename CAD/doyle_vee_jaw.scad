...
// wall — two M6 flats (0.125") under the fender fixed it — so wall_under_head is 0.475". Material verdict: "totally f***s, super strong".)
...
ROOF = pocket_roof == "auto" ? (print_orientation ? "x" : "z") : pocket_roof;
RFL  = roof_flat_in * in;
